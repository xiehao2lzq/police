<template>
  <div class="communityHouse">
    <div class="rightLogo"></div>
    <div class="title clear">
      <p></p>
      <span>社区房屋分布统计</span>
    </div>
    <div id="communityHouse"></div>
  </div>
</template>
...
export default {
  ...
  created() {
    this.$axios({
      method: "get",
      url: "http://" + this.url + ":9000/sjwl/webapi/house/statistics/room",
      headers: {
...
chart.interval().position('xqName*percent')
  .color('xqName', G2.Global.colors_pie_16).label('xqName', {
    offset: 25,
    textStyle: {
      textAlign: 'center',
      shadowBlur: 2,
