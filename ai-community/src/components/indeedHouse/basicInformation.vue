<template>
  <div class="basicInformation">
    ...
    <ul>
      <li class="clear">
        <img src="../../../static/bgImage/communityNum.png" alt />
        <p>小区总数</p>
        <span>{{info.amountSum}}个</span>
      </li>
      <li class="clear">
        <img src="../../../static/bgImage/towerNum.png" alt />
        <p>楼栋总数</p>
        <span>{{info.lyslSum}}个</span>
      </li>
      <li class="clear">
        <img src="../../../static/bgImage/elementNum.png" alt />
        <p>单元总数</p>
        <span>{{info.dysSum}}个</span>
      </li>
      <li class="clear">
        <img src="../../../static/bgImage/houseNum.png" alt />
        <p>房屋总数</p>
        <span>{{info.hsSum}}个</span>
      </li>
    </ul>
  </div>
</template>
...
export default {
  ...
  created() {
    this.$axios({
      method: "get",
      url: "http://" + this.url + ":9000/sjwl/webapi/subdistrict/xqInfo/statistics",
      headers: {
