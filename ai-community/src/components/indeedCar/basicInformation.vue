<template>
    <div class="basicInformation">
        ...
        <ul>
            <li class="clear">
                <img src="../../../static/bgImage/car1.png" alt="">
                <p>登记车辆</p>
                <span>{{info.carTotalNum || 1}}个</span>
            </li>
             <li class="clear">
                <img src="../../../static/bgImage/car2.png" alt="">
                <p>本月感知车辆</p>
                <span>{{info.monthSenseNum || 1}}个</span>
            </li>
             <li class="clear">
                <img src="../../../static/bgImage/car3.png" alt="">
                <p>今日感知车辆</p>
                <span>{{info.todaySenseNum || 1}}个</span>
            </li>
             <li class="clear">
                <img src="../../../static/bgImage/car4.png" alt="">
                <p>今日陌生感知车辆</p>
                <span>{{info.todaySerseStrangerNum || 1}}个</span>
            </li>
        </ul>
    </div>
</template>
...
import {mapState} from "vuex"
  ...
  created() {
    this.$axios({
      method: "get",
      url: "http://" + this.url + ":9000/sjwl/webapi/car/baseInfo",
      headers: {
