<template>
    <div class="basicInformation">
        ...
        <ul>
            <li class="clear">
                <img src="../../../static/bgImage/attention1.png" alt="">
                <p>黑名单</p>
                <span>{{info.blacklistNum}}个</span>
            </li>
             <li class="clear">
                <img src="../../../static/bgImage/attention2.png" alt="">
                <p>特殊人员</p>
                <span>{{info.specialPersonNum}}个</span>
            </li>
             <li class="clear">
                <img src="../../../static/bgImage/attention3.png" alt="">
                <p>特殊车辆</p>
                <span>{{info.specialCarNum}}个</span>
            </li>
        </ul>
    </div>
</template>
...
import {mapState} from "vuex"
  ...
  created() {
    this.$axios({
      method: "get",
      url: "http://" + this.url + ":9000/sjwl/webapi/special/baseInfo",
      headers: {
